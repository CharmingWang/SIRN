...
class CascadeROIHeads(StandardROIHeads):
    ...
    def forward(self, images, features, proposals, targets=None):
        ...
        if self.training:
            ...
            losses, pred_instances = self._forward_box(features, proposals, targets)
    ...
    def _forward_box(self, features, proposals, targets=None):
        ...
        if self.training:
            ...
            #     list_scores_per_image = []

            #     score_i = 0
            #     for score_i in range(len(scores_per_image)):
            #         if scores_per_image[score_i].size(0)==512:
            #             list_scores_per_image.append(scores_per_image[score_i])
            #     scores.append(
            #         sum(list_scores_per_image) * (1.0 / self.num_cascade_stages)
            #     )
